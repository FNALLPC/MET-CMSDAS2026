...
- Precise determination of MET is critical for:
  - Standard Model measurements involving final states with neutrinos
  - searches for physics beyond the SM targeting new weakly interacting particles.
- MET reconstruction is sensitive to:
  - experimental resolutions and mismeasurements of reconstructed particles
  - detector artifacts
  - the effects of additional pp interactions within the same or nearby bunch crossings (pileup).
---
